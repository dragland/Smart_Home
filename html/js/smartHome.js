    ...
    data: {
      ...
      datasets: [
        ...
        },
        {
          data: energy_data,
          label: "energy",
          borderColor: "rgba(247,142,35,1)",
          pointHoverBackgroundColor: "rgba(247,142,35,1)",
          backgroundColor: "rgba(247,142,35,.1)",
          yAxisID: "B",
          lineTension: 0.1,
          borderWidth: 3,
          pointBorderWidth: 1,
        ...
        },
        {
          data: door_data,
          label: "door",
          borderColor: "rgba(253,250,85,1)",
          pointHoverBackgroundColor: "rgba(253,250,85,1)",
          backgroundColor: "rgba(253,250,85,.1)",
          yAxisID: "A",
          lineTension: 0.1,
          borderWidth: 3,
          pointBorderWidth: 1,
